...
<footer class="site-footer"><span>Organized AI / Agentic Engineering · also: <a href="/vibe/">Notes from the Vibe Coders</a> · <a href="/factory/">From Prompts to Factories</a></span><span>Reviewed ${updated} · <a href="${base}/sources/">Evidence & scope</a></span>${isHome?'<button type="button" data-motion-toggle aria-pressed="false">Pause motion</button>':''}</footer>
