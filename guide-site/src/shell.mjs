...
<script src="${base}/assets/app.js?v=${assetVersion}" defer></script><script src="${base}/assets/editorial.js?v=${assetVersion}" defer></script>
...
<aside class="sidebar" id="sidebar">
  ...
  <div class="progress-box"><div><span>YOUR PROGRESS</span><span data-progress-label>0 / 48</span></div><progress max="48" value="0" aria-label="Hands-on milestones complete"></progress><p><a href="${base}/progress/">Open progress dashboard →</a></p></div>
  <nav aria-label="Guide chapters">${navHTML}<p class="nav-group">05 · Put it into practice</p><a class="extra-link" href="${base}/progress/" ${active==='progress'?'aria-current="page"':''}>Hands-on progress</a><a class="extra-link" href="${base}/capstone/" ${active==='capstone'?'aria-current="page"':''}>Capstone & starter lab ↗</a><a class="extra-link" href="${base}/glossary/">Glossary</a><a class="extra-link" href="${base}/sources/">Sources & editorial notes</a><a class="extra-link" href="${base}/book/">Full reading edition</a></nav>
